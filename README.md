...
This is a simple script to download all [EWB](http://www.eichsfeldwerke.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"600073","Arenshausen, Miwepa",9.991878,51.381037,""
```
