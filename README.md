...
This is a simple script to download all [EW](http://www.eichsfeldwerke.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
